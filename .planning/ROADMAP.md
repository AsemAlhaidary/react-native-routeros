...
- [x] 07-01-PLAN.md — Integration harness (jest.integration.config + net/tls module-mapper shims + env gating + COVERAGE.md) + connect/login/write/close tracer against v6+v7

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 07-02-PLAN.md — Command surface: write() service reads, writeStream(), stream(), keepalive
- [x] 07-03-PLAN.md — Robustness + CRUD: User Manager per-version recipes + CRUD, TLS (8729), error handling + !empty gap detection
